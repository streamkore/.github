# streamkore organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`streamkore`](https://github.com/streamkore).

## Canonical organization links

- GitHub organization: https://github.com/streamkore
- Public organization defaults: https://github.com/streamkore/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomstreamkore-b56684b6c8fd
...
`streamkore` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
