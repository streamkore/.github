...
# Repository relationships for `streamkore`
...
- Inventory digest: `sha256:9be1b9b8b7796f323921478977df087787cc47518e9e8911b0c93a04a0b395ce`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:streamkore` |
| GitHub owner ID | `311151603` |
| Linear project ID | `067678fd-c2a3-4d60-b240-9ef5e4f71da4` |
...
|---|---|---|---|
| `streamkore/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
